        ...
        return React.createElement("div", {
          ...
          if (piece !== null) {
            return React.createElement(Cell, {
              piece: piece,
              color: piece.state.moving ? 'green' : color,
              key: x
            });
          } else {
  ...
  _createClass(Piece, [{
    ...
    value: function render() {
      return React.createElement("span", {
        ...
        className: "push-15 img-fluid clickable",
...
function (_Piece) {
  ...
  _createClass(Pawn, [{
    ...
    value: function calculateMoves(y, x) {
      ...
      if (board[y + d + d] !== undefined && board[y + d + d][x] === null && (y - d) % 7 === 0) {
...
function Cell(props) {
  if (props.piece !== null) {
    ...
    return React.createElement("div", {
      className: "col-1 " + props.color
    }, React.createElement(TransparentImg, {
      className: props.color === 'green' ? 'clickable' : ''
    }));
  }
}
...
function TransparentImg(props) {
  return React.createElement("img", {
    className: "push-15 img-fluid " + props.className,
